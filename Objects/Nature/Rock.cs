...
{
    internal class Rock : MeshObject
    {
        public Rock(string name, DirectX3DGraphics directX3DGraphics, Renderer renderer, Vector4 position, Material material, float scale = 0.25f)
            : base(name, directX3DGraphics, renderer, position,
                new MeshObject.VertexDataStruct[24]
                {
                    new MeshObject.VertexDataStruct // front 0
                    {
                        position = new Vector4(-1.0f * scale, 1.0f * scale, -1.0f * scale, 1.0f),
