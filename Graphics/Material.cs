...
namespace Fishing_SharpDX.Graphics
{
    public class Material
    {
        ...
        public Material()
        {
            ...
            _materialProperties.ambient = new Vector4(0.07568f, 0.61424f, 0.07568f, 1.0f);
            _materialProperties.diffuse = new Vector4(0.07568f, 0.61424f, 0.07568f, 1.0f);
            _materialProperties.specular = new Vector4(0.07568f, 0.61424f, 0.07568f, 1.0f);
            _materialProperties.specularPower = 76.8f;
            _materialProperties.textured = 0;
            _texture = null;
        }
        public Material(Texture texture)
        {
            _materialProperties.emissive = new Vector4(0.1f, 0.1f, 0.1f, 1.0f);
            _materialProperties.ambient = new Vector4(0.5f, 0.5f, 0.5f, 1.0f);
            _materialProperties.diffuse = new Vector4(0f, 0f, 0f, 1.0f);
            _materialProperties.specular = new Vector4(0f, 0f, 0f, 1.0f);
            _materialProperties.specularPower = 32f;
            _materialProperties.textured = 1;
            _texture = texture;
        }
