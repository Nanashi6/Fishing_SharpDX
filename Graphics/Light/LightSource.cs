...
namespace Fishing_SharpDX.Graphics.Light
{
    public class LightSource
    {
        ...
        public LightSource()
        {
            _lightSourceProperties.lightType = (int)LightType.SpotLight;
            _lightSourceProperties.position = new Vector4(0.0f, 0.0f, -2.0f, 1.0f);
            _lightSourceProperties.direction = new Vector4(0.0f, 0.0f, 1.0f, 1.0f);
            _lightSourceProperties.color = new Vector4(1.0f, 0.0f, 0.0f, 1.0f);
            _lightSourceProperties.spotAngle = (float)Math.PI / 6.0f;
            ...
            _lightSourceProperties.enabled = 1;
        }
